...
$sqls[] = "CREATE TABLE IF NOT EXISTS `queue_log` (
...
$sqls[] = "CREATE TABLE IF NOT EXISTS `queue_log_history` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `time` char(26) DEFAULT NULL,
  `callid` varchar(32) NOT NULL DEFAULT '',
  `queuename` varchar(32) NOT NULL DEFAULT '',
...
$sqls[] = "DROP TABLE IF EXISTS zone";
$sqls[] = "CREATE TABLE zone (
...
$sqls[] = "CREATE TABLE IF NOT EXISTS report_queue_agents (
    id int(11) unsigned NOT NULL,
    timestamp_out bigint(20),
    timestamp_in varchar(32) NOT NULL,
    qname varchar(32) NOT NULL,
...
$sqls[] = "CREATE TABLE IF NOT EXISTS report_queue_callers (
    id int(11) unsigned NOT NULL,
    timestamp_out bigint(20),
    timestamp_in varchar(32) NOT NULL,
    qname varchar(32) NOT NULL,
...
$sqls[] = "CREATE TABLE IF NOT EXISTS agentsessions (
    qname varchar(32) NOT NULL,
    agent varchar(32) NOT NULL,
...
$sqls[] = "CREATE TABLE if not exists ivr_choice (
