...
NETHVOICE_RELEASED_FREEPBX_IMAGE="${NETHVOICE_RELEASED_FREEPBX_IMAGE:-ghcr.io/nethesis/nethvoice-freepbx:latest}"
LOCAL_TESTING_IMAGE_PULL_POLICY="${LOCAL_TESTING_IMAGE_PULL_POLICY:-missing}"
...
NOTIFY_VOLUME="${NOTIFY_VOLUME:-notify}"
