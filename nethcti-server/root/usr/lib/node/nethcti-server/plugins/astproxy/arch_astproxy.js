...
module.exports = function(options, imports, register) {
  ...
  register(null, {
    astProxy: {
      ...
      hangupUserConfBridgeConf: astProxy.proxyLogic.hangupUserConfBridgeConf,
      endConfBridgeConf: astProxy.proxyLogic.endConfBridgeConf,
      ...
      muteUserConfBridgeConf: astProxy.proxyLogic.muteUserConfBridgeConf,
      isExtenInConfBridgeConf: astProxy.proxyLogic.isExtenInConfBridgeConf,
      ...
      startConfBridgeConference: astProxy.proxyLogic.startConfBridgeConference,
      ...
      EVT_CONFBRIDGE_CONF_END: astProxy.proxyLogic.EVT_CONFBRIDGE_CONF_END,
      EVT_CONFBRIDGE_CONF_CHANGED: astProxy.proxyLogic.EVT_CONFBRIDGE_CONF_CHANGED,
